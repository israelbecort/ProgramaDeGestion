				...
				if(a.equals(btnBaja)) {
					...
					if(dialogResult == JOptionPane.YES_OPTION){
						...
						try
						{
							...
							String cadena= ("DELETE FROM camas WHERE idPacienteFK="+id+";");
						...
						try
						{
							String cadena= ("DELETE FROM pacientes WHERE nombrePaciente='"+nombre+"' AND apellido1='"+ape1+"' AND apellido2='"+ape2+"';");
