...
public class EmpleadosModificacionBuscar extends JFrame implements WindowListener, ActionListener
{
	private static final long serialVersionUID = 1L;

	EmpleadosModificacion empleadosmodificacion=new EmpleadosModificacion(); 
	...
	public EmpleadosModificacionBuscar() {
		...
		btnModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(a.equals(btnModificar)) {
					...
					EmpleadosModificacion.txtNombre.setText(nombre);
					EmpleadosModificacion.txtApe1.setText(ape1);
					EmpleadosModificacion.txtApe2.setText(ape2);
					
					empleadosmodificacion.setVisible(true);
				}
			}
		});
	...
	{
		new EmpleadosModificacionBuscar();
