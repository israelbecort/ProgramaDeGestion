...
public class PacienteAltaCorrecto extends JFrame implements WindowListener, ActionListener
{
	private static final long serialVersionUID = 1L;
	JLabel lblIncorrecto = new JLabel("Alta realizada con éxito.");
	JButton btnAceptar= new JButton("Aceptar");
	
	JPanel pnlSup = new JPanel();
	JPanel pnlInf = new JPanel();
	
	public PacienteAltaCorrecto() {
